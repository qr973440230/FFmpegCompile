...
make -j4
make install
echo "The Compilation of fdk for $CPU is completed"
}
...
export CFLAGS="$COMMON_CFLAGS $EXTRA_CFLAGS"
export LDFLAGS="$COMMON_LDFLAGS $EXTRA_LDFLAGS"
